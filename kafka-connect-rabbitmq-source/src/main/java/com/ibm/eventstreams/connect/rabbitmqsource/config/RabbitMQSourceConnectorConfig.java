...
public class RabbitMQSourceConnectorConfig extends RabbitMQConnectorConfig {
    ...
    // custom for multi hosts | each host would be separated by comma
    public final String hosts;
    public static final String CONFIG_NAME_RABBITMQ_HOSTS = "rabbitmq.hosts";
    public static final String CONFIG_DOCUMENTATION_RABBITMQ_HOSTS = "The name of the the RabbitMQ hosts.";
    ...
    public RabbitMQSourceConnectorConfig(Map<String, String> settings) {
        ...
        this.prefetchGlobal = this.getBoolean(CONFIG_NAME_RABBITMQ_PREFETCH_GLOBAL);
         // custom for multi hosts
         this.hosts = this.getString(CONFIG_NAME_RABBITMQ_HOSTS);
    }
    ...
    public static ConfigDef config() {
        ...
        config.define(CONFIG_NAME_RABBITMQ_PREFETCH_GLOBAL, ConfigDef.Type.BOOLEAN, false, ConfigDef.Importance.MEDIUM, CONFIG_DOCUMENT_RABBITMQ_PREFETCH_GLOBAL);
         // custom for multi hosts
         config.define(CONFIG_NAME_RABBITMQ_HOSTS, ConfigDef.Type.STRING, ConfigDef.Importance.HIGH, CONFIG_DOCUMENTATION_RABBITMQ_HOSTS);
        return config;
    }
}
